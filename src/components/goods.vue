<template>
  <div class="user-container">
    ...
    <el-row>
      ...
      <el-col :span="5">
        <el-button type="success" @click="addFormVisible=true" plain>添加商品</el-button>
      </el-col>
    </el-row>ioioo
    <el-table :data="goodsList" style="width: 100%" border>
      <el-table-column prop="index" label="#" width="40"></el-table-column>
      <el-table-column prop="username" label="商品名称" width="160"></el-table-column>
      <el-table-column prop="email" label="商品价格(元)" width="160"></el-table-column>
